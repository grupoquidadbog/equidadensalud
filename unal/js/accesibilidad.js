...
function ammunition(estilo1,estilo2){
  	var style = estilo1+' '+estilo2;
	var frontPage = document.getElementsByTagName('body')[0].className = style;  	
}
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  document.getElementById("pestania-accesibilidad").addEventListener("keyup", function(event) {
    if (event.key === "Enter") {
      this.click();
    }
  });
